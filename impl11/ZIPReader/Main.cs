...
public static class Main
{
    ...
    [UnmanagedCallersOnly(CallConvs = [typeof(CallConvCdecl)], EntryPoint = nameof(SetZIPVerbosity))]
    ...
    [UnmanagedCallersOnly(CallConvs = [typeof(CallConvCdecl)], EntryPoint = nameof(LoadZIPFile))]
    public static bool LoadZIPFile(nint sZIPFileNamePtr)
    {
        string sZIPFileName = Marshal.PtrToStringAnsi(sZIPFileNamePtr);
        bool result = false;
    ...
    [UnmanagedCallersOnly(CallConvs = [typeof(CallConvCdecl)], EntryPoint = nameof(GetZIPImageMetadata))]
    public static unsafe bool GetZIPImageMetadata(int GroupId, int ImageId, short* Width_out, short* Height_out, byte** ImageData_out, int* ImageDataSize_out)
    {
        ...
        if (ImageData_out != null && ImageDataSize_out != null)
        {
            using (Stream zipImage = zipEntry.Open())
            {
                ...
                zipImage.ReadExactly(data, 0, length);
    ...
    [UnmanagedCallersOnly(CallConvs = [typeof(CallConvCdecl)], EntryPoint = nameof(GetZIPGroupImageCount))]
    ...
    [UnmanagedCallersOnly(CallConvs = [typeof(CallConvCdecl)], EntryPoint = nameof(GetZIPGroupImageList))]
     ...
     */
    [UnmanagedCallersOnly(CallConvs = [typeof(CallConvCdecl)], EntryPoint = nameof(DeleteAllTempZIPDirectories))]
