...
std::vector<const char*> g_DCElemSrcNames = {
	...
	"DUAL_LASER_ENERGY_BAR_L_SRC",  // 50
	"DUAL_LASER_ENERGY_BAR_R_SRC",  // 51
	"QUAD_LASER_ENERGY_BAR_LU_SRC", // 52
	"QUAD_LASER_ENERGY_BAR_LD_SRC", // 53
	"QUAD_LASER_ENERGY_BAR_RU_SRC", // 54
