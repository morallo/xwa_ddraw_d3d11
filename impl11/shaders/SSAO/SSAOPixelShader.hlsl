...
PixelShaderOutput main(PixelShaderInput input)
{
	...
	for (uint j = 0; j < iterations; ++j)
	{
		...
		ao += doAmbientOcclusion(FG, input.uv, coord1 * 0.25, p, n /*, bentNormal */);
		ao += doAmbientOcclusion(FG, input.uv, coord2 * 0.5,  p, n /* dummy */);
		ao += doAmbientOcclusion(FG, input.uv, coord1 * 0.75, p, n /* dummy */);
		ao += doAmbientOcclusion(FG, input.uv, coord2, p, n /* dummy */);
	}
